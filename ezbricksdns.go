...
import (
	...
	"github.com/raghava-reddy-invimatic/ezbricksdns"
)

// Provider wraps the provider implementation as a Caddy module.
type Provider struct{ *ezbricksdns.Provider }
...
func (Provider) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "dns.providers.ezbricksdns",
		New: func() caddy.Module { return &Provider{new(ezbricksdns.Provider)} },
	}
}
